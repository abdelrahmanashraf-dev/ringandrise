...
// The new Global Wrapper implementation
export const SmoothScrollHero = ({ children }) => {
    return (
        <ReactLenis
            root
            options={{
        ...
        >
            <div className="smooth-scroll-global-wrapper">
...
const GlobalParallaxBackground = () => {
    return (
        <div className="global-parallax-container">
            <ParallaxImg
                src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2670&auto=format&fit=crop"
                alt="Analytics"
                start={0}
                end={500}
                className="global-parallax-img"
                style={{ width: '20vw', top: '10vh', left: '-5vw', opacity: 0.05 }}
            />
            <ParallaxImg
                ...
                className="global-parallax-img"
                style={{ width: '30vw', top: '40vh', right: '-10vw', opacity: 0.05 }}
            />
            <ParallaxImg
                ...
                className="global-parallax-img"
                style={{ width: '25vw', top: '80vh', left: '15vw', opacity: 0.05 }}
            />
        </div>
    );
};
...
const ParallaxImg = ({ className, alt, src, start, end, style }) => {
    ...
    return (
        <motion.img
            ...
            className={className}
            ref={ref}
            style={{ transform, ...style, position: 'absolute', pointerEvents: 'none', zIndex: 0, filter: 'grayscale(100%)' }}
        />
    );
};
